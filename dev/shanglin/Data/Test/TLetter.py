...
def runTL(session, pid, n_practices, n_trials):
    ...
    csv_path = f"E:/data6/ind-spacevtime/Test/Data/{pid}_TLetter.csv"
...
nPractices = 5
nTrials = 50
runTL(3, pid, nPractices, nTrials)
runTL(4, pid, nPractices, nTrials)
runTL(5, pid, nPractices, nTrials)